...
En rouge, nous avons les valeurs prévues après le lissage exponentiel de Holt-Winters et en noir les valeurs initiales. Les deux courbes sont quasiment superposées, ce qui nous indique un bon ajustement. \
...
Dans ce cas, les prévisions sont dans la continuité des données. Nous pouvons noter une légère décroissance pour les 30 prochaines semaines à venir.
